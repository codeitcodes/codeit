...
class CodeitElement extends HTMLElement {
  ...
  constructor() {
    ...
    cd.addEventListener('keydown mousedown mouseup touchstart touchend focus blur', () => { reqNextFrame(checkCaretPosEvent) }, false);
...
console.log('%ccodeit.js 2.7.2', 'font-style: italic; color: gray');
