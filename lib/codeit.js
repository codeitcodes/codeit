...
class CodeitElement extends HTMLElement {
  ...
  constructor() {
    ...
    cd.highlight = (lang) => {
      ...
      // if text is big, highlight asynchronously
      // with web workers
      let highlightAsync = false;
      
      if (cd.textContent.length > 5000) {
        highlightAsync = true;
        console.log('[codeit.js] Highlighting asynchronously');
      }
      
      // highlight element
      Prism.highlightElement(cd, highlightAsync);
