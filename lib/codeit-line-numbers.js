(function () {
	...
	window.addEventListener('resize', function () {
		...
		config.update(Array.prototype.slice.call(document.querySelectorAll(PLUGIN_NAME)));
	});

	document.querySelector('cd-el').on('modify', function () {
		config.update(document.querySelector('cd-el'));
	});
