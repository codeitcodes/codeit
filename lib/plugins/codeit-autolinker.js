(function () {
	...
	Prism.hooks.add('wrap', function (env) {
      ...
      // show pointer when pressed ctrl/cmd + shift
      env.attributes.onkeydown = 'if ((event.ctrlKey || event.metaKey) && event.shiftKey) { this.style.cursor = "pointer"; }';
			env.attributes.onkeyup = 'if ((event.ctrlKey || event.metaKey) && event.shiftKey) { this.style.cursor = ""; }';
