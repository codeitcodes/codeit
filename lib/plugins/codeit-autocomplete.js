...
acp.language.css.init = () => {
  ...
  let CSSProps = acp.language.css.props;
...
/*
 * autocomplete language function
 *
 * defined as:
 * acp.language.[lang].autocomplete(query)
 * |
 * [lang] - language name
 * query - text before cursor
 *
 * returns:
 * results - array of result strings
 * 
 * disable automatic result sorting:
...
// move autocomplete menu to caret
acp.utils.moveMenuToCaret = (cursor) => {
