(function () {
  ...
  const topHitEl = document.querySelector('.top-hit');
...
function onType() {
  ...
  let query = cursor.startContainer.textContent.replaceAll(' ','').replaceAll('\n','');
  ...
  if (query !== '' &&
    ...
    if (matches.length !== 0)  {
      ...
      matches.forEach((match, index) => {
        ...
        // show it at the top of the list
      ...
      if (matches.length === 1
        ...
        console.log('[Autocomplete] Top hit: ' + matches[0]);
