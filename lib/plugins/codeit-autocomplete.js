      ...
      if (menu.classList.contains('visible')) {
        ...
        if (e.key === 'Enter' || e.keyCode === 13) { // if pressed enter
          ...
          if (activeSuggestion.nextElementSibling) {
            ...
            activeSuggestion.nextElementSibling.scrollIntoViewIfNeeded();
          ...
          if (activeSuggestion.prevElementSibling) {
            
            // select previous suggestion
            activeSuggestion.prevElementSibling.classList.add('active');
            activeSuggestion.classList.remove('active');
            
            activeSuggestion.prevElementSibling.scrollIntoViewIfNeeded();
    ...
    cd.on('type', () => {
      ...
      if (config[cd.lang]) {
        ...
        if (cursor && !cursor.in('string') && !cursor.in('comment')) {
          ...
          console.log(cursor.startContainer);
