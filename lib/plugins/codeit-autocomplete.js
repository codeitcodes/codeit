...
function handleMenuKeydown(e) {
  ...
  if (suggestions.classList.contains('visible')) {
    ...
    if (e.key === 'ArrowDown') {
      ...
      if (!next) next = suggestions.querySelector('.icon:first-of-type');
      ...
      let topHitHTML = '<b>' + prevQuery + '</b>' + topHit.slice(prevQuery.length);
      ...
      let prev = active.prevElementSibling;
      
      if (!prev) prev = suggestions.querySelector('.icon:last-of-type');
