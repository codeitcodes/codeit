    ...
    function handleTabCharacters(event) {
      ...
      if (event.key === 'Tab') {
        ...
        if (event.shiftKey) {
          ...
          if (padding.length > 0 && start === pos.start) {
